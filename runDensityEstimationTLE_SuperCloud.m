function runDensityEstimationTLE_SuperCloud(yr,mth,dy,nofDays,DMDmodel,r,selectedObjects)
...
%     [tumin, mu, radiusearthkm, xke, j2, j3, j4, j3oj2] = getgravc( whichconst );
    ...
    maxAlt = 100000; % km
    [yrf, mthf, dyf, ~, ~, ~] = datevec(jdf+20-1721058.5);
    ...
    %%
    % Load BC estimates
    medianBCestimates20172018 = ...
        [11822,	0.00907878222982622;    13770,	0.0119172584049643;     15354,	0.0104993335141488;
        16111,	0.00911779416489363;    24547,	0.0367465477907777;     25735,	0.00623449143072065;
        28822	0.0152985628114510;     35867,	0.00958762377732438;    38710,	0.00946087770259095;
        38998,	0.00797160419184476;    39452,	0.00520899789522335;    43020,	0.0190711951730938;
        ...
        41970, 0.0403420104279107]; %42735, 42911, 43019 not available at 1 Jan 2017
    
    medianBCestimates20012003 = ...
    ...
    stateFnc = @(xx,t0,tf) propagateStateMEE_FullGravDrag_New(xx,t0,tf,AC,BC,Inp2,r,nop,svs,F_U,M_U,et0,jd0);
    ...
    stateFnc = @(t,x) propagateStatePosVel_FullGravDrag_ROM(t,x,et0_gps,romStateTime,r_pred,F_U_pred,M_U,includeSRPMoonSunPert);
    measurementFcn = @(xx) pvBC2p(xx);
    resScaling = [1;1;1];
    ...
    romStateTime_pred = [romStateOut_pred, romTimeOut_pred+etf_ukf]; % ROM modes and ephemeris time
    ...
    %
    sampleTime_pred_full = [0:5:et_gps_pred(end)-et0_gps];
